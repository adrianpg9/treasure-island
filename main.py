...
if direction == 'left':
  lake_choice = input('You come to a lake. There is an island in the middle of the lake. Type "swim" to swim across or type "wait" to wait for a boat\n')
  if lake_choice == 'wait':
    ...
    if color == 'yellow':
      ...
      print("The room you entered is full of fire, game over.")
    else:
      print("Game over.")
  else:
    print("You can't swim, game over.")
